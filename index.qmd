...
39. Suppose you have the following confusion matrix for a binary classification problem where the positive class is “Adelie”:
...
40. What is the precision for the “Adelie” class?
...
41. What is the sensitivity (recall) for the “Adelie” class?
...
42. Based on the precision and recall calculated above, what is the F1-score for the “Adelie” class?
...
43\. If a classifier has a low F1-score, which of the following is most likely true?
